...
import 'package:edu_platform/features/courses/data/models/courses_model.dart';

abstract class CoursesDataSource {
  Future<GenericPagination<CoursesModel>> coursesList();
}
...
class CoursesDataSourceImpl extends CoursesDataSource {
  ...
  @override
  Future<GenericPagination<CoursesModel>> coursesList() async {
    try {
      ...
      if (response.statusCode! >= 200 && response.statusCode! < 300) {
        return GenericPagination.fromJson(
            response.data, (p0) => CoursesModel.fromJson(p0 as Map<String, dynamic>));
      }
